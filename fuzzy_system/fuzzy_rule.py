...
class FuzzyRule:
	...
	@trust_rating.setter
	def trust_rating(self, rating):
		self._trust_rating = rating
		self._degree = self._degree * rating
	...
	def evaluate_score(self):
		...
		return output_control * self._trust_rating, center_values
	...
	def __str__(self):
		...
		cf = f' CF = {self._trust_rating}'
		return f'If {ante} then {cons} with {cf}'
